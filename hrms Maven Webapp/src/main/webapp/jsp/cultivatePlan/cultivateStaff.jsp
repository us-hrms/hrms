		    ...
		    <div class="container-fluid well" id="container-Info">
		      ...
		      <div class="container-fluid" style="margin-top:20px;border-left:1px dashed #008080;border-right:1px dashed #008080;border-radius:20px;padding:30px 40px 0px;max-width:95%;">
		        <table class="ui blue selectable celled table">
		          <thead>
		            <tr>
		              <th colspan="6" class="h4 center aligned"><span style="letter-spacing:20px;">培训人员及成绩信</span>息</th>
		            </tr>
		            <tr>
		              <th>工号 / No</th>
		              <th>姓名 / Name</th>
		            ...
		            <tr>
		              <th colspan="6">
		                ...
		                <div class="col-md-2 col-md-offset-5">
		                  <button class="btn btn-info btn-block" data-toggle="modal" data-target="#newCulti"><span style="letter-spacing:10px;">添加培训信</span>息</button>
		                </div>
		              </th>
		            </tr>
		          </tfoot>
		 	...
		 	<!-- 新增部门 Model -->
	        <div class="modal fade" id="newCulti" tabindex="-1" role="dialog" aria-labelledby="CultiModel" style="margin-top:230px;">
	          <div class="modal-dialog" role="document">
	            <div class="modal-content">
	              <div class="modal-header">
	                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	                <h4 class="modal-title" id="CultiModel">添加员工培训</h4>
	              </div>

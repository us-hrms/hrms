...
<head>
  ...
  <body>
	...
	<div class="container-fluid" style="max-width:96%;">
		    ...
		    <form >
		      ...
		      <div class="container-fluid" style="border-top:1px dashed #87CEEB;border-bottom:1px dashed #87CEEB;border-radius:20px;padding:20px 0px 10px 0px;max-width:90%;">
		        ...
		        <div class="form-group form-inline text-center col-md-offset-1 col-md-10">
		          ...
		          <div class="form-group col-md-4">
		              <label class="control-label">奖 罚 类 型：</label>
		              <select class="form-control" style="width:196px;">
		                <option value="-1">全部</option>
		                <option value="false">奖</option>
		                <option value="true">罚</option>
		              </select>
		          </div>
		        </div>
		        <div class="form-group form-inline text-center col-md-offset-1 col-md-10">
		      ...
		      <div class="container-fluid" style="margin-top:20px;border-left:1px dashed #008080;border-right:1px dashed #008080;border-radius:20px;padding:30px 40px 0px;max-width:95%;">
		        <table class="ui blue selectable celled table">
		          <thead>
		            <tr>
		              <th colspan="7" class="h4 center aligned"><span style="letter-spacing:20px;">奖罚信</span>息</th>
		            </tr>
		            <tr>
		              <th>工号 / No</th>
		              <th>姓名 / Name</th>
		          ...
		          <tbody>
		          <c:forEach items="${punishmentRewardlists}" var="item">
		            <tr>
		              <td>${item.staff.no}</td>
		            ...
		            <tr>
		              <th colspan="7">
		                ...
		                <div class="col-md-2 col-md-offset-5">
		                  <button class="btn btn-info btn-block" data-toggle="modal" data-target="#newReward"><span style="letter-spacing:10px;">新增奖罚信</span>息</button>
		                </div>
		              </th>
		            </tr>
		          </tfoot>
		...
		<!-- 新增奖罚 Model -->
	        <div class="modal fade" id="newReward" tabindex="-1" role="dialog" aria-labelledby="RewardModal" style="margin-top:230px;">
	          <div class="modal-dialog" role="document">
	            <div class="modal-content">
	              <div class="modal-header">
	                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
	                <h4 class="modal-title" id="RewardModal">选择员工</h4>
	              </div>
